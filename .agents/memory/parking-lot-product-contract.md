...
**Canonical doc:** [`docs/PARKING_LOT_CONTRACT.md`](../../docs/PARKING_LOT_CONTRACT.md) (v0.3 — milestone complete / freeze)  
**Audit:** [`docs/audits/parking-lot-product-audit.md`](../../docs/audits/parking-lot-product-audit.md)  
**Freeze:** [`docs/audits/parking-lot-milestone-freeze.md`](../../docs/audits/parking-lot-milestone-freeze.md)  
...
Milestone is **frozen**. Do not redesign. Bugfixes and precision-biased pattern adds only.
...
4. Confidence: ≥95 auto-park, 80–94 ask (ParkConsentCard), <80 skip
...
7. Auto-resolve is precision-first (prefer miss over false positive)
8. Prefer exit (resolve / promote / delete) over endless intake
