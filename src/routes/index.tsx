  ...
  return (
    <>
      ...
      <div
        ...
        className="relative h-full overflow-y-auto px-5 pt-6 flex flex-col"
        style={{ gap: "var(--bubble-gap, 20px)", overflowAnchor: "none", paddingBottom: "calc(var(--footer-nav-height, 62px) + 220px + env(safe-area-inset-bottom, 0px))" }}
      >
