...
function WorkspacePage() {
  ...
  const mainShell = (
    <div className="atlas-shell-host h-full min-h-0 bg-background text-foreground overflow-hidden">
  ...
  return (
    <DesktopWorkspace
      ...
      ledgerCount={ledgerCount}
      renderMobile={() => {
        const mobileArtifacts = detectArtifacts(messages);
        return (
          <MobileShell
                  ...
                  {projects.map((p) => {
                    ...
                    return (
                      <button
                        ...
                        className={[
                          "w-full text-left rounded px-3 py-2 text-[12px] transition-colors",
                          active
              ...
              <div className="h-full flex flex-col p-3 gap-3">
                ...
                {mobileArtifacts.length === 0 ? (
                  <div className="flex-1 flex items-center justify-center p-6 text-center">
                    <p className="text-[11px] font-mono text-muted-foreground max-w-[28ch] leading-relaxed">
                      Artifacts (code, docs, tables) generated by Atlas appear here.
                    </p>
                  </div>
                ) : (
                  <div className="flex flex-col gap-2">
                    {mobileArtifacts.map((a) => (
                      ...
                      >
                        ...
                        <h3 className="text-[12px] font-medium text-foreground mb-1.5 truncate">
                          {a.title}
                        </h3>
                        <pre className="text-[10.5px] font-mono text-muted-foreground whitespace-pre-wrap break-words max-h-48 overflow-auto leading-relaxed">
                          {a.body.slice(0, 600)}
                          {a.body.length > 600 ? "\n…" : ""}
                        </pre>
                      </button>
