...
- feature_grid: { layout: "feature_grid", heading, features: [{ title, description }] (2-4) }
- timeline: { layout: "timeline", heading, milestones: [{ label, description? }] (2-6) }
- kpi_metrics: { layout: "kpi_metrics", heading, metrics: [{ value, label }] (2-4) }
- comparison: { layout: "comparison", heading, columns: [{ title, points: string[] }] (exactly 2) }
- process_flow: { layout: "process_flow", heading, steps: [{ title, description? }] (2-5) }
