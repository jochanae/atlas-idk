    ...
    <div style={{ minHeight: "100dvh", background: "var(--atlas-bg)", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, maxWidth: 680, margin: "0 auto", padding: "48px 24px 80px", width: "100%" }}>
        ...
        <Section title="01 // Acceptance">
          By accessing or using Joy, you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the service. These terms constitute a binding legal agreement between you and Into Innovations LLC.
        </Section>

        <Section title="02 // Description of Service">
          Joy is a strategic thinking partner designed for founders and builders. It helps you track commitments, notice when direction shifts, and maintain a structured record of the choices that shape your projects. Joy is a thinking aid — not a substitute for professional legal, financial, or business advice.
        </Section>

        <Section title="03 // User Accounts">
          You must create an account to use Joy. You are responsible for maintaining the confidentiality of your login credentials and for all activities that occur under your account. You must notify us immediately of any unauthorized use of your account at{" "}
        ...
        <Section title="04 // Your Data">
          <p style={{ marginBottom: 12 }}>You own your data. Projects, sessions, chat messages, and decision entries you create in Joy belong to you. We do not sell, rent, or share your personal data with third parties for marketing purposes.</p>
        ...
        <Section title="05 // Acceptable Use">
          <p style={{ marginBottom: 12 }}>You agree not to use Joy to:</p>
        ...
        <Section title="06 // AI Features">
          Joy uses large language models to provide strategic guidance and decision logging functionality. AI responses are generated automatically and may occasionally be incorrect or incomplete. You are responsible for verifying any AI-generated output before acting on it. We do not guarantee the accuracy, reliability, or suitability of AI responses for any particular purpose.
        </Section>

        <Section title="07 // Subscription & Payments">
          Certain features of Joy may require a paid subscription. Pricing, billing cycles, and tier benefits will be communicated at the point of purchase. Refund policies will be outlined in the subscription agreement presented at the time of payment. We reserve the right to change pricing with reasonable notice to existing subscribers.
        </Section>

        <Section title="08 // Intellectual Property">
          The Joy platform, including its design, code, and branding, is the intellectual property of Into Innovations LLC. You may not copy, modify, or distribute any part of the platform without our express written permission. Your content remains yours.
        </Section>

        <Section title="09 // Disclaimer of Warranties">
          Joy is provided "as is" and "as available" without any warranties of any kind, express or implied. We do not warrant that the service will be uninterrupted, error-free, or free of harmful components. Your use of the service is at your own risk.
        </Section>

        <Section title="10 // Limitation of Liability">
          To the fullest extent permitted by law, Into Innovations LLC shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of or inability to use Joy, even if we have been advised of the possibility of such damages.
        </Section>

        <Section title="11 // Termination">
          We reserve the right to suspend or terminate your account at our discretion if you violate these terms or engage in conduct we determine to be harmful to other users or the platform. You may terminate your account at any time by contacting support. Upon termination, your right to use Joy ceases immediately.
        </Section>

        <Section title="12 // Changes to Terms">
          We may update these Terms of Service from time to time. When we do, we will update the date above. Continued use of Joy after changes constitutes your acceptance of the updated terms.
        </Section>
