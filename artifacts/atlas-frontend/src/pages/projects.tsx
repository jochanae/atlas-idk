        ...
        <div style={{ display: "flex", alignItems: "center", gap: isTinyMobile ? 4 : 8 }}>
          ...
          {hasGithubAccess && backendReady && (
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(22,163,74,0.22)"; e.currentTarget.style.borderColor = "rgba(22,163,74,0.75)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = "rgba(22,163,74,0.14)"; e.currentTarget.style.borderColor = "rgba(22,163,74,0.55)"; }}
            >
              <svg width="11" height="11" viewBox="0 0 16 16" fill="rgb(22,163,74)">
